...
const chunksSplit_1 = require("../../services/chunksSplit");
beforeAll(() => { });
afterAll(() => { });
describe("Chunks Split Service", () => {
    test("test chunk splitting with basic text", () => {
        ...
        const chunks = (0, chunksSplit_1.splitIntoChunks)(movie, { maxChars: 50, overlapChars: 15 });
    ...
    test("test chunk splitting with repeated text", () => {
        ...
        const chunks = (0, chunksSplit_1.splitIntoChunks)(movie, { maxChars: 80, overlapChars: 20 });
    ...
    test("test empty description", () => {
        ...
        const chunks = (0, chunksSplit_1.splitIntoChunks)(movie);
    ...
    test("test single short sentence", () => {
        ...
        const chunks = (0, chunksSplit_1.splitIntoChunks)(movie, { maxChars: 50, overlapChars: 10 });
    ...
    test("test overlap functionality", () => {
        ...
        const chunks = (0, chunksSplit_1.splitIntoChunks)(movie, { maxChars: 40, overlapChars: 15 });
...
//# sourceMappingURL=chunksSplit.test.js.map