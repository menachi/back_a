...
router.post("/", commentController_1.default.post.bind(commentController_1.default));
router.delete("/:id", commentController_1.default.del.bind(commentController_1.default));
router.put("/:id", commentController_1.default.put.bind(commentController_1.default));
