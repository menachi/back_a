...
### 4. Rate Limiting
The service has rate limiting (100 requests per minute per IP). Implement exponential backoff for retries.
...
3. **Model not found**: Check available models with `/api/llm/models`
